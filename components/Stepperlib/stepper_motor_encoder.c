...
#define STEPPER_MOTOR_DIR_PIN GPIO_NUM_32
#define STEPPER_MOTOR_STEP_PIN GPIO_NUM_35
*/
...
static void stepper_motor_init() {
    // Configurer la broche DIR en tant que sortie
    gpio_config_t dir_pin_config = {
        .pin_bit_mask = 1ULL << STEPPER_MOTOR_DIR_PIN,
    ...
    // Configurer la broche STEP en tant que sortie
    gpio_config_t step_pin_config = {
        .pin_bit_mask = 1ULL << STEPPER_MOTOR_STEP_PIN,
        .mode = GPIO_MODE_OUTPUT,
        .pull_up_en = GPIO_PULLUP_DISABLE,
        .pull_down_en = GPIO_PULLDOWN_DISABLE,
        .intr_type = GPIO_INTR_DISABLE
